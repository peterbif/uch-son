...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12 showResult">
            ...
            <table class="table table-bordered" id="myTable">
                ...
                <tr><td colspan="12" style="background-color: #000000"> <h6  style="color: #ffffff; font-size: 17px; text-align: center;">APPLICATION FORM FOR ENTRY INTO THE <?php echo  @$record_res2['school'] ;?>, UCH, IBADAN </h6> <!--<img align="right" src="saved_images/<?php echo @$result_pass['capture'];?>" class="img-rounded" width="90px" height="90px" />--> </td></tr>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <p> c) &nbsp;I shall accept as final, the decision of the GNEEC - SONUCHI with regard to any examination center and course of stude.</p>
