...
<div class="container-fluid" >
    ...
    <div class="marquee">
        <p id="div1"><span style="color: deeppink; background-color: #FFFFFF" id="son"> The List of Successful Candidates for SON Entrance Examination, 2019/2020 Academic Session:  <a href="1st_set.pdf"><i class="fa fa-list-ol"> 1st List</i></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="2nd_set.pdf"><i class="fa fa-list-ol"> 2nd List</i></a>
        </p>
