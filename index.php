...
<div class="container-fluid" >
    ...
    <div class="marquee">
        <p id="div1"><span style="color: deeppink; background-color: #FFFFFF" id="son">School of Nursing: Please login to the Portal with ur email & password to confirm that the Passport on your Photo Card is intact or upload another one without you may not be able to login for the exam. <a href="http://son.uch-ibadan.org.ng/">For Exam Date, Venue and Batch NO  Click here......</a>
        </p>
