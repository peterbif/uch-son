    ...
    <div class="row">
        <div class="col-lg-12 showResult">
            ...
            <table class="table table-bordered" id="myTable">
                <tbody>
                <tr><td colspan="12" style="background-color: #000000" align="center"><span  style="color: #ffffff; font-size: 20px;">GENERAL NURSING ENTRANCE EXAMINATION COMMITTEE</span> <br /> <span style="color: #ffffff; font-size: 17px;"> <?php echo  @$record_res2['school'] ;?> U. C. H., IBADAN (GNEEC-SONUCHI)</span></td></tr>

                <tr style="border-collapse: collapse;"><td colspan="3" align="left" style="border-right: 0px"><img  src="uploads/<?php echo @$result_logo['logo'];?>" class="img-rounded" width="120px" height="100px" /></td><td id="form_no"  align="center" colspan="2"><span style="font-size: 16px;">FORM NO</span> <br /><br /><span style="font-size: 20px; font-weight: bolder"><?php echo @$record_res2['form_no']; ?></span></td> <td colspan="3"><img  align="right" src="thumbs/<?php echo @$result_pass['capture'];?>" class="img-rounded" width="120px" height="100px" /></span></td></tr>
            ...
            <div class="col-lg-12">
                ...
                <p style="padding-top: 70px;" align="center">
                    ........................................................................................<br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;Principal's / Chairman's Signature/Stamp (GNEEC SONUCHI)
                </p>
            </div>
        </div>
